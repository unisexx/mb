...
<h2 style="margin-top:0;">Top Friends</h2>
		...
		<a href="#" class="thumbnail" data-toggle="modal" data-target="#myModal-<?php echo $row->id?>">
			<img src="uploads/user/<?php echo $row->image?>" style="width: 120px; height: 120px;">
		</a>
		<?php endforeach;?>
		<?php foreach($topfriend as $row):?>
<!-- Modal -->
      ...
      <div class="modal-body">
        ...
        <div class="profile-header">
            ...
            <div class="list-detail">
                ...
                <div><?php echo badWordFilter($row->detail); ?></div>
                
                    <div><?php echo $row->placeholder?>: <?php echo $row->social_data; ?></div>

                
                <span class="label" style="background: <?php echo $row->color?>"><?php echo $row->title; ?></span>
                <span class="label label-warning"><?php echo $row->province?></span>
            </div>
