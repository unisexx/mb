...
<form id="frmMain" method="post" action="stickers/admin/stickers/save/<?=$line->id?>" enctype="multipart/form-data">
    <table class="form">
        ...
        <tr>
            ...
            <td>
                <select name="category">
                    ...
                    <option value="india" <?php echo ($line->category == 'india')?'selected=selected':'';?>>อินเดีย</option>
                    <option value="taiwan" <?php echo ($line->category == 'taiwan')?'selected=selected':'';?>>ไต้หวัน</option>
                    <option value="indonesia" <?php echo ($line->category == 'indonesia')?'selected=selected':'';?>>อินโดนีเซีย</option>
                    <option value="us" <?php echo ($line->category == 'US')?'selected=selected':'';?>>อเมริกา</option>
                    <option value="china" <?php echo ($line->category == 'china')?'selected=selected':'';?>>จีน</option>
                    <option value="malaysia" <?php echo ($line->category == 'china')?'selected=selected':'';?>>มาเลเชีย</option>
                    <option value="???" <?php echo ($line->category == '???')?'selected=selected':'';?>>???</option>
                </select>
            </td>
        </tr>
        <tr>
