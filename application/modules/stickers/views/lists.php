...
.list::first-letter{color:#5B4282;font-weight:bold;}
</style>
<div class="container">
    <div class="span8">
        <div id="letter-index">
        ...
        <table class="table table-striped">
            <?php foreach($stickers as $sticker):?>
                <tr>
                    <td class="list"><a id="<?php echo substr(ucfirst($sticker->title),0,1)?>" class="sticker-name" href="line://shop/detail/<?php echo $sticker->sticker_code?>" alt="<?php echo $sticker->title?>"><?php echo $sticker->title?></a></td>
                </tr>
            <?php endforeach;?>
        </table>
    </div>
