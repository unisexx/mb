        ...
        <tr>
        	...
        	<td>
        		<select name="category">
        			<option value="การใช้งานเว็บไซต์" <?=$page->category == 'การใช้งานเว็บไซต์' ? 'selected' : '' ;?>>การใช้งานเว็บไซต์</option>
        			<option value="เกมไลน์" <?=$page->category == 'เกมไลน์' ? 'selected' : '' ;?>>เกมไลน์</option>
        		</select>
        	</td>
        </tr>
        <tr>
