...
<iframe src="https://www.facebook.com/plugins/like.php?app_id=136698876474938&href=http://www.line2me.in.th'.$_SERVER['PATH_INFO'].'&send=true&layout=button_count&width=135&show_faces=false&action=like&colorscheme=light&font&height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:135px; height:21px;" allowTransparency="true"></iframe>
<!--<g:plusone size="medium"></g:plusone>
<a href="http://www.line2me.in.th'.$_SERVER['PATH_INFO'].'" class="twitter-share-button" data-url="http://www.line2me.in.th'.$_SERVER['PATH_INFO'].'" data-via="your_screen_name" data-lang="en" data-related="anywhereTheJavascriptAPI">Tweet</a>-->
</div></div><br><br>';
}
...
function meta_description($description=false){
    ...
    if($description){
        ...
        $CI->template->append_metadata( meta('description','โสด เหงา หาเพื่อน หากิ๊ก หาแฟน หาเพื่อนเล่นเกม มาแลกไอดีไลน์กัน มีเพื่อนแจ่มๆ น่ารักมากมาย รอพูดคุยกับคุณอยู่เพียบเลยจ้า~'));
    }
}
...
function badWordFilter($data){
    $originals = array("เย็ด","ควย","ค่วย","หี","กู","มึง","เหี้ย","เงี่ยน");
    // $replacements = array("friend","love","wow");
    $data = str_ireplace($originals,'***',$data);
    return $data;
}
?>